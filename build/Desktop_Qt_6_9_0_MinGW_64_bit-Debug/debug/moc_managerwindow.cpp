...
template <> constexpr inline auto managerWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13managerWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "managerWindow",
        "on_addDeadBodyButton_clicked",
        "",
        "showDeadBodiesDialog",
        "on_viewDeadBodiesButton_clicked",
        "on_searchDeadBody_clicked",
        "on_Logout",
        "on_viewVisitors_clicked",
        "on_buttonBox_accepted",
        "on_EditDeadBody_clicked",
        "on_deleteDeadBodyButton_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_addDeadBodyButton_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'showDeadBodiesDialog'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_viewDeadBodiesButton_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_searchDeadBody_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_Logout'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_viewVisitors_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonBox_accepted'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_EditDeadBody_clicked'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_deleteDeadBodyButton_clicked'
...
void managerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_addDeadBodyButton_clicked(); break;
        case 1: _t->showDeadBodiesDialog(); break;
        case 2: _t->on_viewDeadBodiesButton_clicked(); break;
        case 3: _t->on_searchDeadBody_clicked(); break;
        case 4: _t->on_Logout(); break;
        case 5: _t->on_viewVisitors_clicked(); break;
        case 6: _t->on_buttonBox_accepted(); break;
        case 7: _t->on_EditDeadBody_clicked(); break;
        case 8: _t->on_deleteDeadBodyButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
